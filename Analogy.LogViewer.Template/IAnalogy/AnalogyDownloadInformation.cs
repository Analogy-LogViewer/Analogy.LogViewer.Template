...
{   
    ...
    public abstract class AnalogyDownloadInformation : IAnalogyDownloadInformation
    {
        ...
        protected AnalogyDownloadInformation(Guid primaryFactoryId, string name)
        {
            Name = name;
            PrimaryFactoryId = primaryFactoryId;
        }

        protected AnalogyDownloadInformation(Guid primaryFactoryId, string name, bool isUpdateAvailable, string? downloadUrl, string? changeLogUrl, string? latestVersionNumber, string? installedVersionNumber, bool mandatory, string? installerArgs, string? checksum, string? hashingAlgorithm) : this(primaryFactoryId, name)
        {
